...
inline int Sock::close()
{
	if (sockfd != INVALID_SOCKET)
	{		
		::close(sockfd);
		//printf("Sock::close - sock[%d]\n", sockfd);
...
inline int Sock::getopt( int level, int optname, void *optval, int *optlen)
{
	int rv = 0;
...
inline int Sock::setopt( int level, int optname, void *optval, int optlen)
{
	int rv = 0;
...
inline void Sock::set_nonblocking() 
{
	int rv = 0;	
	// non-blocking socket
	#ifdef _WIN32
...
*/
inline void Sock::set_reuseaddr_on() 
{
...
*/
inline void Sock::set_tcpnodelay_on() 
{
	int nodelay = 1;	
...
/**
 KEEP_ALIVE
*/
inline void Sock::set_keepalive_on() 
{
	int keepalive = 1;
...
*/
inline void Sock::set_linger_on() 
{
...
*/
inline void Sock::set_linger_off() 
{
...
inline void Sock::set_sendbuffsize( int bufsize) 
{
	setopt(SOL_SOCKET, SO_SNDBUF, &bufsize, sizeof(bufsize));
}

inline void Sock::set_recvbuffsize( int bufsize) 
{
	setopt(SOL_SOCKET, SO_RCVBUF, &bufsize, sizeof(bufsize));	
}

inline int Sock::store_err()
{
#ifdef _WIN32
