...
== 사용법 ==
 1.  
     * PmsLogMsg::logprint() 을 직접 호출하지 않고 MACRO (LOG_PRN, ACE_LOG_MSG, ACE_HEX_DUMP) 를 이용한다.
...
#else
#define	LOG_PRN(X)	PmsLogMsg::logprint X
#endif


#define	LOG_OPEN	PmsLogMsg::open
#define	HEX_DUMP(X)	PmsLogMsg::hexdump X
#define	LOG_MSG	PmsLogMsg::getInstance()
